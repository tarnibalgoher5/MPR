                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="add_expense.php?edit=<?php echo $row['expense_id']; ?>"  class="btn btn-primary btn-md" style="border-radius:10px; padding:6% margin:4%">Edit</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="add_expense.php?delete=<?php echo $row['expense_id']; ?>" class="btn btn-danger btn-md" style="border-radius:10px; padding:6% margin:4%">Delete</a>
                                    </td>
                                </tr>
                            <?php $count++; } ?>
                        </table>
