                    ...
                    <hr>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:10px; padding:2% margin:4%;" name="save" type="submit">SAVE CHANGES</button>
                                </div>
                            <!-- border-radius:10px; padding:2% margin:4%">LOGIN</button> -->
                            </div>
                        </form>
                        <!--/tab-content-->
